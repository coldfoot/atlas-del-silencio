var data = [
    {label: "Digital", percent: 20.8},
    {label: "Impreso", percent: 4.9},
    {label: "Radio", percent: 16.9},
    {label: "Red social", percent: 51.5},
    {label: "TV", percent: 5.5},
    {label: "No contestó", percent: 0.8},
...
var svg = d3.select(".preferencia-medios").append("svg")
...
svg.selectAll(".bar")
    ...
    .style("fill", function(d, i) { return i === 0  ? "#774DCB" : "#BFA9E2"; }); // Lighter color for bars other than the first one;
